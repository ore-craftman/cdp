export default function Loader() {
  return (
    <div className="flex space-x-2 justify-center items-center bg-transparent h-[20vh] ">
...
export function Spinner() {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="w-6 h-6 text-100 animate-spin dark:text-transparent fill-gray-500"
        viewBox="0 0 100 101"
        fill="none"
